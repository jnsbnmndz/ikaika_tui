"""`TemplatePack` adapter for the Flutter stack, dispatching to `behavior.py`."""
...
from company_tui.templates.flutter import behavior
from company_tui.templates.services import PackServices


class FlutterTemplatePack(TemplatePack):
    ...
    def info(self) -> TemplatePackInfo:
        return TemplatePackInfo(
            ...
            name="Flutter",
            version="0.1.0",
            description="Flutter mobile, desktop, and web project template pack",
        )
